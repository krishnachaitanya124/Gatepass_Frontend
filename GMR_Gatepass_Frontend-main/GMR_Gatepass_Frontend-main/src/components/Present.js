...
const Present = () => {
    ...
    return (
        <div className="container mx-auto px-2 sm:px-4 py-4">
            <h1 className="text-center font-bold text-gray-800 mb-4 mt-4 text-xl md:text-2xl">Students Present in Hostel</h1>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mt-4 gap-2 px-2">
                <div className="text-sm text-gray-700 order-1 sm:order-none">
                    Showing {indexOfFirstRow + 1} to {Math.min(indexOfLastRow, students.length)} of {students.length} entries
                </div>
